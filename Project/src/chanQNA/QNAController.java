...
public class QNAController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(url.indexOf("list.do")!=-1) {
			...
			String page="/Project20_02/QNA.jsp";
			...
			dao.insert(dto);
			String page="/chanqna_servlet/list.do";
			...
			String page="/Project20_02/QNAView.jsp";
			RequestDispatcher rd=request.getRequestDispatcher(page);
			rd.forward(request, response);
			...
			request.setAttribute("dto", dto);
			String page="/Project20_02/QNAReply.jsp";
			RequestDispatcher rd=request.getRequestDispatcher(page);
			rd.forward(request, response);
			...
			String page="";
			if(result !=null) {
				page="/Project20_02/QNAEdit.jsp";
				request.setAttribute("dto", dao.view(num));
				RequestDispatcher rd=request.getRequestDispatcher(page);
				rd.forward(request, response);
			}else {
				page=contextPath+"/chanqna_servlet/view.do?num="+num+"&message=error";
			...
			request.setAttribute("listqna", list);
			//출력 페이지 이동
			String page="/Project20_02/QNAComment_list.jsp";
			RequestDispatcher rd=request.getRequestDispatcher(page);
			rd.forward(request, response);
