...
<script type="text/javascript">
	...
	$(function() {
		$("#btnWrite").click(function() {
			location.href="${path}/Project20_02/FAQWrite.jsp";
		});
	});
	
	function list(page) {
		location.href="${path}/chanfaq_servlet/list.do?curPage="+page;
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right2">
		...
		<div class="contents">
			...
			<form name="form1" method="post" action="${path}/chanfaq_servlet/search.do">
				<div class="finds">
								...
								<c:when test="${dto.show =='y' }">
									<tr>
										...
										<th>
											...
											<a href="${path}/chanfaq_servlet/view.do?num=${dto.num }" style="color: white;  ">${dto.subject }</a>
											<!-- 댓글갯수 표시-->
