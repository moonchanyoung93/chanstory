...
<link
	href="https://fonts.googleapis.com/css?family=Gaegu:400,700&display=swap&subset=korean"
	rel="stylesheet">
<script
	...
	<form action="${path}/chansession_servlet/login.do">
		<div id="mySidenav" class="sidenav">
			...
			<div style="margin: auto; width: 80%;">
				...
				<hr
					style="color: white; border: 0.4px solid; opacity: 0.2; width: 95%; margin: 20px 2px;">
				<div style="width: 95%; margin: 20px 2px;">
					<ul class="nav mypage">
						<li class="nav-item mypage_li"><a
							class="nav-link mypage_li_a" href="#"><span
								class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;마이페이지</a></li>
						<li class="nav-item mypage_li"><a
							class="nav-link mypage_li_a" href="#"><span
								class="glyphicon glyphicon-heart-empty"></span>&nbsp;&nbsp;주문내역</a></li>
						<li class="nav-item mypage_li"><a
							class="nav-link mypage_li_a" href="#"><span
								class="glyphicon glyphicon-shopping-cart"></span>&nbsp;&nbsp;장바구니</a></li>
						<li class="nav-item mypage_li"><a
							class="nav-link mypage_li_a" href="#"><span
								class="glyphicon glyphicon-barcode"></span>&nbsp;&nbsp;쿠폰</a></li>
						<li class="nav-item mypage_li"><a
							class="nav-link mypage_li_a" href="#"><span
								class="glyphicon glyphicon-piggy-bank"></span>&nbsp;&nbsp;적립금</a></li>
						<li class="nav-item mypage_li"><a
							class="nav-link mypage_li_a" href="#"><span
								class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;예치금</a></li>
						<li class="nav-item mypage_li"><a
							class="nav-link mypage_li_a" href="#"><span
								class="glyphicon glyphicon-comment"></span>&nbsp;&nbsp;문의내역</a></li>
					</ul>
				</div>
				<hr
					style="color: white; border: 0.4px solid; opacity: 0.2; width: 95%; margin: 20px 2px;">
				...
				<div style="width: 95%;">
					<button type="button" class="btnLogOut" onclick="Logout()">Log
						Out</button>
				</div>
			</div>
	...
	<div id="main">
		...
		<div class="jumbotron">
			<div class="container text-center ">
				<a href="../Project20_02/main_login.jsp"><img
					src="../Project20_02/images/logo.png" width="30%" class="logo_img"></a><br>
				<br>
		...
		<div class="contents">
			...
			<form name="form1" method="post" enctype="multipart/form-data"
				action="${path}/chanqna_servlet/insert.do">
				<div class="write">
					<table border="2" width="70%" style="margin: auto;">
						...
						<tr>
							...
							<td><select name="subject" id="subject"
								style="width: 250px;" class="inputstyle">
									<option value="상품 문의합니다.">상품 문의합니다.</option>
									<option value="교환/반품 문의합니다.">교환/반품 문의합니다.</option>
									<option value="배송 문의합니다.">배송 문의합니다.</option>
									<option value="입금 확인 문의합니다.">입금 확인 문의합니다.</option>
									<option value="배송 전 취소/변경 문의합니다.">배송 전 취소/변경 문의합니다.</option>
									<option value="환불 문의합니다.">환불 문의합니다.</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td><textarea rows="15" cols="140" name="content"
									id="content" class="inputstyle">
■  문의
- 빠른 확인과 처리를 위해 문의 하실 상품명을 함께 기재 해주세요.
- 사이즈 문의 시 보다 정확한 답변을 위해 키와 몸무게를 함께 기재해주세요.
- 상품 재고 문의는 주문 후 익일(다음 날)부터 답변 가능합니다.
...
문의 내용 :
						...
						<tr>
							...
							<td><div class="terms">
									■ 개인정보의 수집·이용 목적<br> 서비스 제공 및 계약의 이행, 구매 및 대금결제, 물품배송 또는
									청구지 발송, 회원관리 등을 위한 목적<br> ■ 수집하려는 개인정보의 항목<br> 이름,
									주소, 연락처, 이메일 등<br> ■ 개인정보의 보유 및 이용 기간<br> 회사는 개인정보 수집
									및 이용목적이 달성된 후에는 예외없이 해당정보를 파기합니다.<br> #개인정보의 위탁 처리 찬스토리
									쇼핑몰은 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의
									개인정보를 외부에 위탁하여 처리하고 있습니다. 찬스토리 쇼핑몰 의 개인정보처리 수탁자와 그 업무의 내용은 다음과
									같습니다.<br> - 수탁자 : (주)찬스토리- 위탁 업무 내용 : 카카오톡 알림톡 발송 업무<br>
									───────────────────────────────────
			...
			<footer class="container-fluid text-center">
				<div class="footer_div">
					<div class="footer_div1">
						<a href="../Project20_02/main_login.jsp"><img
							src="../Project20_02/images/logo.png"></a>
				...
				<div>
					<a href="http://www.instagram.com"><img
						...
						src="../Project20_02/images/facebook2.png" width="50"></a>
				</div>
				<hr style="border: 1px solid white; opacity: 0.1;">
