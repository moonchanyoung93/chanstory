...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnList").click(function() {
			location.href="/Project/Project20_02/notice2.jsp";
		});
		$("#btnReply").click(function() {
			document.form1.action="${path}/chanboard_servlet/reply.do";
			document.form1.submit();
		});
		$("#btnEdit").click(function() {
			document.form1.action="${path}/chanboard_servlet/pass_check.do";
			document.form1.submit();
		});
	});
...
function comment_add() {
	...
	$.ajax({
		type:"post",
		url: "${path}/chanboard_servlet/comment_add.do",
		data: param,
		success: function(){
			$("#writer").val("");
			$("#content").val("");
...
function comment_list(){
	$.ajax({
		type: "post",
		url: "${path}/chanboard_servlet/commentList.do",
		data: "num=${dto.num}",
				...
				<div class="notice_viewtable">
					<table border="3" width="70%" style="margin: auto;">
						...
						<tr>
					        ...
					        <a href="${path}/chanboard_servlet/download.do?num=${dto.num}">
					        [다운로드]</a>
					 	     </c:if>
						</tr>
						<tr>
