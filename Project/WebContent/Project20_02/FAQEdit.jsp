...
<script type="text/javascript">
	...
	$(function() {
		$("#btnUpdate").click(function() {
			document.form1.action="${path}/chanfaq_servlet/update.do";
			document.form1.submit();
		});
		$("#btnDelete").click(function(){
			if(confirm("삭제하시겠습니까?")){
				document.form1.action="${path}/chanfaq_servlet/delete.do";
				document.form1.submit();			
			}
		});
				...
				<div class="notice_viewtable">
					<table border="3" width="70%" style="margin: auto;">
						...
						<tr>
							...
							<td colspan="3"><input name="subject" id="subject" value="${dto.subject}" class="inputstyle" size="100"></td>
						</tr>
