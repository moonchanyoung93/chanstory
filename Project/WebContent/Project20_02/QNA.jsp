...
<script type="text/javascript">
	...
	$(function() {
		$("#btnWrite").click(function() {
			location.href="${path}/Project20_02/QNAWrite.jsp";
		});
	});
	function list(page) {
		location.href="${path}/chanqna_servlet/list.do?curPage="+page;
								...
								<c:when test="${dto.show =='y' }">
									<tr>
										...
										<th>
											...
											<a href="${path}/chanqna_servlet/view.do?num=${dto.num }" style="color: white; ">${dto.subject }</a>
											<!-- 댓글갯수 표시-->
